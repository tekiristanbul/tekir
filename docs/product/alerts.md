...
- creating a needs-help update requires authenticated bearer identity. ordinary text-only updates may be posted using anonymous device identity without account login — this is an explicit exception to the authentication rule recorded in [[trust]].
